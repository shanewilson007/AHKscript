...
; #include C:\Users\shane\vim_ahk\vim.ahk
...
#q::Send !{F4}
#b::Run "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Microsoft Edge"
#Enter::Run "C:\Program Files\WindowsApps\Microsoft.WindowsTerminal_1.10.2383.0_x64__8wekyb3d8bbwe\WindowsTerminal.exe"
#+Enter::Run "C:\Program Files\PowerShell\7\pwshA.exe.lnk"
#c::Run "python"


;#n::Run "wt -d C:\Users\Shane\dev\electron\notepad ; npm start"
...
~^s::
    WinGetActiveTitle, Reload
        If InStr(Reload, ".ahk")
            {
            WinMenuSelectItem, %Reload%, , File, Save
            Reload
            Return
            }
    Return
